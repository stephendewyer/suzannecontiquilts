...
<section 
	...
	>
    <div class="colophon_content_container">
        <div class="colophon_heading_container">
            <h1 class="colophon_heading">colophon</h1>
            <img 
                class="stitches"
                src="{stitches}" 
                alt="stitches" 
